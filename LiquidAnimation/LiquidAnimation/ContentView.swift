...
struct ContentView: View {
            ...
            Rectangle()
                ...
                .overlay {
                    ZStack {
                        ...
                        Icons(show: $show, icon: "books.vertical", Yoffset: 211, SAnimation: 0.22, delay: 0.14)
                        Icons(show: $show, icon: "person.badge.plus", Yoffset: 301, SAnimation: 0.22, delay: 0.14)
    ...
    var canvas: some View {
        Canvas{ context,size in
            ...
            CanCircle(show: $show, Yoffset: 180, sanimation:0.3, tag: 3)
            CanCircle(show: $show, Yoffset: 270, sanimation:0.3, tag: 4)
        }
    }
}
